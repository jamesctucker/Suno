...
export { default as ListsModal } from '../../components/lists/ListsModal.vue'
...
export { default as TodosTodoList } from '../../components/todos/TodoList.vue'
...
export const LazyListsModal = import('../../components/lists/ListsModal.vue' /* webpackChunkName: "components/lists-modal" */).then(c => c.default || c)
...
export const LazyTodosTodoList = import('../../components/todos/TodoList.vue' /* webpackChunkName: "components/todos-todo-list" */).then(c => c.default || c)
